/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config ../../wrangler.json` (hash: 2544acb6fb2d2fb0c9b073edecc143e4)
// Runtime types generated with workerd@1.20260301.1 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: string;
		PUBLIC_TANSTACK_WEB_URL: string;
		PUBLIC_TANSTACK_API_PATH: string;
		DATABASE_URL: string;
		AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "PUBLIC_TANSTACK_WEB_URL" | "PUBLIC_TANSTACK_API_PATH" | "DATABASE_URL" | "AUTH_SECRET" | "AUTH_GOOGLE_CLIENT_ID" | "AUTH_GOOGLE_CLIENT_SECRET" | "AUTH_DISCORD_CLIENT_ID" | "AUTH_DISCORD_CLIENT_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
