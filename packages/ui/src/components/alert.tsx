  ...
  'relative grid w-full grid-cols-[0_1fr] items-start gap-y-0.5 rounded-lg border px-4 py-3 text-sm has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] has-[>svg]:gap-x-3 [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current',
  {
    variants: {
      variant: {
        ...
        'default-outline':
          'text-card-foreground [&_[data-slot=alert-description]]:text-muted-foreground bg-transparent',
        'info-outline':
          'border-info text-info [&>svg]:text-info [&_[data-slot=alert-description]]:text-info/80 bg-transparent',
        'success-outline':
          'border-success text-success [&>svg]:text-success [&_[data-slot=alert-description]]:text-success/80 bg-transparent',
        'warning-outline':
          'border-warning text-warning [&>svg]:text-warning [&_[data-slot=alert-description]]:text-warning/80 bg-transparent',
        'destructive-outline':
          'border-destructive text-destructive [&>svg]:text-destructive [&_[data-slot=alert-description]]:text-destructive/80 bg-transparent',
      },
    },
    defaultVariants: {
      variant: 'default',
